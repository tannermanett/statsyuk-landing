        ...
        {siteConfig.pricing.map((plan, index) => (
          <motion.div
            ...
            className={cn(
              ...
              plan.isPopular ? "border-accent border-[2px]" : "border-border",
              index === 0 || index === siteConfig.pricing.length - 1
          ...
          >
            {plan.isPopular && (
              <div className="absolute top-0 right-0 bg-accent py-0.5 px-2 rounded-bl-xl rounded-tr-xl flex items-center">
